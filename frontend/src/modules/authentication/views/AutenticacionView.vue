<template>
    ...
    <div class="flex items-center justify-between h-16 bg-white border-b border-gray-200">
        <div class="flex items-center px-4">
            ...
            <div :class="!authStore.isAuthenticated ? 'text-sm text-blue-900' : 'text-sm text-red-800'">
        ...
        <div @click="onLogout" class="flex justify-center items-center px-2 py-1">
            <button class="inline-flex items-center justify-center px-2 py-2
          text-lg font-bold text-white
          bg-gradient-to-r from-indigo-500 to-indigo-700 dark:from-indigo-500 dark:to-indigo-700 rounded-xl drop-shadow-md transform-gpu hover:rotate-[2deg] hover:scale-110 hover:skew-x-1
          transition-all duration-30 shadow-lg hover:shadow-3xl will-change-transform">
                <svg height="30px" width="30px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 503.808 503.808" xml:space="preserve"
                    fill="#000000">
...
const { usuario, isAuthenticated, isChecking } = storeToRefs(authStore)
